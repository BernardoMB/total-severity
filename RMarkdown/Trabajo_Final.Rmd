...
```
Suponiendo que la frecuencia de los siniestros se distribuye Poisson, entonces, estimando por maxima verocimilitud se obtiene que, en promedio, ocurren 
...
En donde $T$ es el total de años sobre los cuales se tiene información y $N_j$ es el número de siniestros que ocurrieron en el $j$-ésimo año.
